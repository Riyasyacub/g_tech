...
class InstallmentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create installment" do
    assert_difference("Installment.count") do
      post installments_url, params: { installment: { amount: @installment.amount, date: @installment.date, student_id: @installment.student_id } }
    end
  ...
  test "should update installment" do
    patch installment_url(@installment), params: { installment: { amount: @installment.amount, date: @installment.date, student_id: @installment.student_id } }
